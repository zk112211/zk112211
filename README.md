...
### [Pedestrian Attribute Detection Pipeline](https://github.com/zk112211/Pedestrian_Attribute_Detection_Pipeline)
...
### [AI Life Planning Assistant](https://github.com/zk112211/AI-Life-Planning-Assistant)
Multi-agent trip planner (Scout → Simulator → Validator) powered by Google Gemini API. Built with Flutter frontend and FastAPI backend with real-time WebSocket alerts.

### [TypeScript Static Analyzer](https://github.com/zk112211/TypeScript-Static-Analyzer)
...
### [Distributed Blockchain (PBFT)](https://github.com/zk112211/simple-pbft-blockchain)
